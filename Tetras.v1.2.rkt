...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |Tetras v1.2|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
; TETRAS game

; Aaron Lindsay and Michelle Lee (updated version)
; Lab Section 01, TA: Calvin
